...
public class ServiceAgreementActivity extends AppCompatActivity {
    ...
    private ConstraintLayout layout_serviceRule;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_serviceRule = findViewById(R.id.layout_serviceRule);
        iv_moveToback = findViewById(R.id.iv_moveToback);
        webView = findViewById(R.id.wv_serviceRule);
        ...
        webView.loadUrl(ApplicationConstants.WEBRTC_SERVER_URL + "/content/service");
    }
    ...
    public void destroyWebView() {
        ...
        layout_serviceRule.removeAllViews();
